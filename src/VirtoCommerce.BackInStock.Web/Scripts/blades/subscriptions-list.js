angular.module('VirtoCommerce.BackInStock')
    .controller('VirtoCommerce.BackInStock.backInStockSubscriptionsController',
        ['$scope', 'BackInStock.WebApi', 'platformWebApp.bladeUtils', 'uiGridConstants',
            'platformWebApp.uiGridHelper', 'platformWebApp.authService', 'VirtoCommerce.BackInStock.entityTypesResolverService',
            function ($scope, reviewsApi, bladeUtils, uiGridConstants, uiGridHelper, authService, entityTypesResolverService) {
                ...
                blade.selectNode = function (data) {
                    ...
                    if (!authService.checkPermission('backInStock:update')) {
                        return;
                    }
                    ...
                    var newBlade = {
                        ...
                        controller: 'VirtoCommerce.BackInStock.reviewDetailController',
                        template: 'Modules/$(VirtoCommerce.BackInStock)/Scripts/blades/review-detail.tpl.html'
                    };
